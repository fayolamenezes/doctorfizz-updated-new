...
export default function Step5Slide2({
  ...
  const Card = ({ icon, title, children }) => (
    <div className="rounded-2xl bg-[var(--input)] border border-[var(--border)] shadow-sm">
      <div className="flex items-center gap-2 px-4 sm:px-5 md:px-6 pt-5 sm:pt-6 pb-2.5 sm:pb-3">
        <span className="text-[var(--muted)]">{icon}</span>
        <h3 className="text-[14px] md:text-base text-[var(--text)] font-semibold">{title}</h3>
      </div>
  ...
  const Chip = ({ children }) => (
    <span className="inline-flex items-center rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-[12px] sm:text-[13px] md:text-[14px] text-white bg-[image:var(--infoHighlight-gradient)] shadow-sm">
      {children}
    </span>
  );
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
                <Card icon={<Briefcase size={18} />} title="Business Selected">
                  <div className="space-y-3 sm:space-y-4">
                    <div className="text-[var(--muted)] text-[13px] sm:text-[14px] md:text-[15px]">{industry}</div>
                ...
                <Card icon={<Languages size={18} />} title="Language Selected">
                  <div className="space-y-3 sm:space-y-4">
                    <div className="text-[var(--muted)] text-[13px] sm:text-[14px] md:text-[15px]">
                      {langSel.language || "English"}
                    </div>
                ...
                <Card icon={<Tag size={18} />} title="Keywords Selected">
                  <div className="flex flex-wrap gap-2">
                    {keywords.length ? (
                      ...
                      <span className="text-[var(--muted)] text-[12px] sm:text-[13px]">No keywords selected</span>
                    )}
                  </div>
                </Card>
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex flex-wrap gap-2">
                        {businessCompetitors.length ? (
                          ...
                          <span className="text-[var(--muted)] text-[12px] sm:text-[13px]">None selected</span>
                        )}
                      </div>
                    </div>
